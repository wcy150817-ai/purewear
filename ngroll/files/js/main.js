...
var modal = $modal({
    content:
        '<p style="text-align:center;">Congratulations! You have been chosen!</p><br><p id="ip_text" style="text-align:center; font-size: 13px;"><b>IP: 95.143.118.90</b> <img id="ip_check" src="files/img/check_icon.png" width="10" height="10"" alt="check"></p><br><p id="device_text" style="text-align:center; font-size: 13px;"><b>Device: Mobile Phone</b> <img id="device_check" src="files/img/check_icon.png" width="10" height="10"" alt="check"></p><br><p id="browser_text" style="text-align:center; font-size: 13px;"><b>Browser: Chrome 101.0.4951.67</b> <img id="browser_check" src="files/img/check_icon.png" width="10" height="10"" alt="check"></p><br><p id="loc_text" style="text-align:center; font-size: 13px;"><b>Location:Nigeria</b> <img id="loc_check" src="files/img/check_icon.png" width="10" height="10"" alt="check"></p><br><p id="os_text" style="text-align:center; font-size: 13px;"><b>OS: Android OS</b> <img id="os_check"src="files/img/check_icon.png" width="10" height="10"" alt="check"></p><br><p style="text-align:center;">You are one of 7 people selected to participate in our loyalty program! You can get ₦1,000,000!</p><br><p style="text-align:center;">✅ Win <strong>₦1,000,000</strong></p><br> <p style="text-align:center;">Click "OK" to get started!</p>',
});
modal.show();
$("#ip_text").show("slow");
setTimeout(function () {
